...
class ModInputdynatrace_problem(base_mi.BaseModInput):
    ...
    def collect_events(helper, ew):
        ...
        response = helper.send_http_request(api_url, "GET", headers=headers, parameters=None, payload=None,
        ...
        event = helper.new_event(data='{"dynatrace_server":"' + opt_dynatrace_tenant + '"}', index=None, source=None,
                                 sourcetype=None)
        ew.write_event(event)
